...
程序计数器（PC）符号化`},style:{background:`#f0f9ff`,borderColor:`#0284c7`}}],edges:[{id:`e1`,source:`compile`,target:`mem`},{id:`e2`,source:`runtime`,target:`sync`},{id:`e3`,source:`asm`,target:`call`},{id:`e4`,source:`mem`,target:`tsan`},{id:`e5`,source:`sync`,target:`tsan`},{id:`e6`,source:`call`,target:`tsan`},{id:`e7`,source:`tsan`,target:`detect`},{id:`e8`,source:`tsan`,target:`report`}],height:660,minZoom:.82})}function _(){let e=[{id:`app`,position:{x:250,y:20},data:{label:`1. 应用内存
...
16 / 8 = 2×`}}];return(0,o.jsx)(f,{nodes:e,edges:[{id:`e1`,source:`app`,target:`shadow`},{id:`e2`,source:`shadow`,target:`slots`},{id:`e3`,source:`shadow`,target:`ratio`}],height:460,minZoom:.82})}function v(){let e=[{id:`word`,position:{x:250,y:30},data:{label:`Shadow Word
